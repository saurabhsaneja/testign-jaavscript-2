...
const AuthenticatedApp = (props) => {
    ...
    const fetchStoriesByCategories = useCallback(async (customSections) => {
        ...
        try {
            ...
            customSections.filter(section => section.sectionType === SectionType.STORYCOLLECTION).map((section, index) => {
            ...
            let _data = []
            customSections.filter(item => item.sectionType === SectionType.STORYCOLLECTION ).forEach(item => {
